...
- Failure Statistics: aggregates error code frequency over time
...
- graph_nodes: Resolve node pubkeys for display in the dashboard
...
- Failure Statistics: a summary panel showing total payments, success rate, failure rate, and most common error codes
